...
public class pengaduan extends javax.swing.JFrame {
    ...
    void no_kode() {
        try {
            ...
            String sql = "Select right(no_pengaduan,3)+1 from pengaduan";
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Isi Pengaduan");
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, 70, 50));
        ...
        getContentPane().add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 290, 70, 50));
        ...
        getContentPane().add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 290, 80, 50));
        ...
        getContentPane().add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 290, 70, 50));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("G:\\BAHAN UKKKKK\\iAN\\applikasi_aduan Test\\applikasi_aduan\\src\\gambar\\vektor 3.png")); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 720, -1));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/vektor2.jpg"))); // NOI18N
        jPanel1.add(jLabel2);

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 800, 480));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vektor 3.png"))); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 0, 90, 140));
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        try {
            ...
            if (JOptionPane.showConfirmDialog(this, "Yakin menghapus data", "Peringatan", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
                con.queryDelete("pengaduan", "no_pengaduan=" + no);
    ...
    private void jSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jSearchActionPerformed
        ...
        if (txt_search.getText().isEmpty()) {
            ...
            try {
                rs = con.querySelectAll("pengaduan", "no_pengaduan LIKE '%" + txt_search.getText() + "%' OR tgl LIKE '%" + txt_search.getText() + "%' OR nik LIKE '%" + txt_search.getText() + "&'");
    ...
    private void loadTabel() {
     ...
     private void create() {
        ...
        System.out.println(con.queryInsert("pengaduan", kolom, isi));
        JOptionPane.showMessageDialog(this, "Data Pengaduan Berhasil Disimpan");
