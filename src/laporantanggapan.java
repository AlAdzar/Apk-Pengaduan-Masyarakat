 ...
 * @author suyoto
 */
public class laporantanggapan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LAPORAN TANGGAPAN");
        ...
        getContentPane().add(txt_from, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 80, 190, -1));

        txt_to.setForeground(new java.awt.Color(255, 255, 255));
        txt_to.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        getContentPane().add(txt_to, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 80, 190, -1));
        ...
        getContentPane().add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 80, 100, 30));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try{
            String NamaFile = "./src/laporan/reporttanggapan.jasper";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new laporantanggapan().setVisible(true);
            }
        });
    }
